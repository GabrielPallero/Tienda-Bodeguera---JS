...
botonVaciar.addEventListener('click',function(){Swal.fire({
    ...
    construirCarrito()})}
//Botones mas y menos
const btnmasmenos =e => {Toastify({text:"Producto agregado/quitado",
    duration:2000,
    destination:"https://apvarun.github.io/toastify-js/#",
    gravity:"top",
    position:"left",
